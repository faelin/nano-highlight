%% This file is a small sample Erlang script to test the syntax highlighting
%% of Erlang scripts/programs in Nano.  It is a copy of find.erl taken
%% from here: http://www1.erlang.org/examples/examples-2.0.html
%% This file is an exact copy of the aforementioned file with the only
%% difference between the two is that this file has this header comment
%% added to it.
